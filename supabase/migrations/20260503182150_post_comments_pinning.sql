...
BEGIN
  ...
  IF v_post_source = 'user' THEN
    -- Strip the "u-" prefix that the frontend prepends
    SELECT EXISTS (
  ...
  -- Clear any other pin on the same post, then toggle this one
