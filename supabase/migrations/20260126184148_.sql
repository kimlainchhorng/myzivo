-- Create a test driver record for sample data (will be associated with first user who signs up)
-- First, let's insert sample trips with null driver_id that can be viewed by admins
-- We'll also create a function to associate trips with a driver when they sign up

-- Insert sample completed trips for testing (these will need a driver_id)
-- We'll create a temporary function to help with this
...
BEGIN
  ...
  (p_driver_id, 'Bella Italia Restaurant, 123 Main St', '456 Oak Avenue, Apt 12B', 
   ...
   12.50, 18, 3.2, 5, 'completed', 'completed', 
  ...
  (p_driver_id, 'Golden Dragon, 789 Broadway', '321 Park Place', 
   ...
   8.75, 12, 2.1, 4, 'completed', 'completed',
  ...
  (p_driver_id, 'Burger Palace, 555 5th Ave', '888 Lexington Ave', 
   ...
   15.00, 22, 4.5, 5, 'completed', 'completed',
  ...
  (p_driver_id, 'Sushi Express, 100 East 42nd St', '200 West 34th St', 
   ...
   9.25, 15, 2.8, 5, 'completed', 'completed',
  ...
  (p_driver_id, 'Pizza Hub, 300 Canal St', '400 Houston St', 
   ...
   7.50, 10, 1.5, 4, 'completed', 'completed',
  ...
  (p_driver_id, 'Taco Bell, 500 Spring St', '600 Bleecker St', 
   ...
   11.00, 14, 2.3, 5, 'completed', 'completed',
  ...
  (p_driver_id, 'Chipotle, 700 7th Ave', '800 8th Ave', 
   ...
   6.50, 8, 1.2, 4, 'completed', 'completed',
  ...
  (p_driver_id, 'Shake Shack, 900 Madison Ave', '1000 Park Ave', 
   ...
   13.75, 20, 3.8, 5, 'completed', 'completed',
  ...
  (p_driver_id, 'Five Guys, 1100 Columbus Ave', '1200 Amsterdam Ave', 
   ...
   10.25, 16, 2.9, 4, 'completed', 'completed',
  ...
  (p_driver_id, 'Panera Bread, 1300 Broadway', '1400 6th Ave', 
   ...
   8.00, 11, 1.8, 5, 'completed', 'completed',
  ...
  (p_driver_id, 'Sweetgreen, 1500 Park Ave', '1600 Lexington Ave', 
   ...
   14.50, 19, 3.5, 5, 'completed', 'completed',
  ...
  (p_driver_id, 'Chick-fil-A, 1700 3rd Ave', '1800 2nd Ave', 
   ...
   7.25, 9, 1.4, 4, 'completed', 'completed',
