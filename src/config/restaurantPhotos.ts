...
// Using optimized Unsplash URLs with consistent 1:1 aspect ratio
export const restaurantPhotos: Record<RestaurantCuisine, RestaurantPhoto> = {
  ...
  sushi: {
    src: "https://images.unsplash.com/photo-1579871494447-9811cf80d66c?w=300&h=300&fit=crop&q=80",
    alt: "Fresh sushi platter - Japanese cuisine",
  },
  pizza: {
    src: "https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=300&h=300&fit=crop&q=80",
    alt: "Artisan pizza with fresh toppings - Italian cuisine",
  },
  taco: {
    src: "https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=300&h=300&fit=crop&q=80",
    alt: "Fresh tacos with colorful toppings - Mexican cuisine",
  },
  noodles: {
    src: "https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=300&h=300&fit=crop&q=80",
    alt: "Thai noodles in bowl - Asian cuisine",
  },
  salad: {
    src: "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=300&h=300&fit=crop&q=80",
