...
// Batch 3 - More branded car models
import carChevroletCamaro from "@/assets/car-chevrolet-camaro.jpg";
import carGmcYukon from "@/assets/car-gmc-yukon.jpg";
import carRam1500 from "@/assets/car-ram-1500.jpg";
import carLincolnNavigator from "@/assets/car-lincoln-navigator.jpg";
import carBuickEnclave from "@/assets/car-buick-enclave.jpg";
import carInfinitiQx80 from "@/assets/car-infiniti-qx80.jpg";
import carAcuraMdx from "@/assets/car-acura-mdx.jpg";
import carMiniCooper from "@/assets/car-mini-cooper.jpg";
import carMitsubishiOutlander from "@/assets/car-mitsubishi-outlander.jpg";
import carJeepGrandCherokee from "@/assets/car-jeep-grandcherokee.jpg";
import carVolkswagenId4 from "@/assets/car-volkswagen-id4.jpg";
import carHyundaiIoniq6 from "@/assets/car-hyundai-ioniq6.jpg";
import carKiaEv6 from "@/assets/car-kia-ev6.jpg";
import carFordMachE from "@/assets/car-ford-machE.jpg";
import carChevroletBolt from "@/assets/car-chevrolet-bolt.jpg";
import carBmwIx from "@/assets/car-bmw-ix.jpg";
import carMercedesEqs from "@/assets/car-mercedes-eqs.jpg";
import carAudiEtron from "@/assets/car-audi-etron.jpg";
import carPorscheTaycan from "@/assets/car-porsche-taycan.jpg";
import carNissanAriya from "@/assets/car-nissan-ariya.jpg";
...
export const brandedCarModels: BrandedCarModel[] = [
  ...
  // Batch 3 - American Brands
  {
    id: "chevrolet-camaro",
    brand: "Chevrolet",
    model: "Camaro",
    category: "luxury",
    src: carChevroletCamaro,
    alt: "Chevrolet Camaro - American muscle coupe",
    fuelType: "gas",
    passengers: 4,
    bags: 2,
    transmission: "auto",
  },
  {
    ...
    category: "suv",
    src: carGmcYukon,
    alt: "GMC Yukon - Full-size premium SUV",
    fuelType: "gas",
    passengers: 8,
    bags: 5,
    transmission: "auto",
  },
  {
    ...
    category: "suv",
    src: carRam1500,
    alt: "RAM 1500 - Full-size pickup truck",
    fuelType: "gas",
    passengers: 5,
    bags: 6,
    transmission: "auto",
  },
  {
    ...
    model: "Navigator",
    category: "luxury",
    src: carLincolnNavigator,
    alt: "Lincoln Navigator - American luxury SUV",
    fuelType: "gas",
    passengers: 7,
    bags: 5,
    transmission: "auto",
  },
  {
    ...
    category: "suv",
    src: carBuickEnclave,
    alt: "Buick Enclave - Premium midsize SUV",
    fuelType: "gas",
    passengers: 7,
    bags: 4,
    transmission: "auto",
  ...
  // Japanese Luxury Brands
  {
    ...
    category: "luxury",
    src: carInfinitiQx80,
    alt: "Infiniti QX80 - Japanese luxury SUV",
    fuelType: "gas",
    passengers: 7,
    bags: 5,
    transmission: "auto",
  },
  {
    ...
    category: "luxury",
    src: carAcuraMdx,
    alt: "Acura MDX - Premium Japanese SUV",
    fuelType: "hybrid",
    passengers: 7,
    bags: 4,
    transmission: "auto",
  ...
  // Compact / Economy
  {
    ...
    category: "compact",
    src: carMiniCooper,
    alt: "Mini Cooper - British compact icon",
    fuelType: "gas",
    passengers: 4,
    bags: 1,
    transmission: "auto",
  },
  {
    ...
    model: "Outlander",
    category: "suv",
    src: carMitsubishiOutlander,
    alt: "Mitsubishi Outlander - Family crossover SUV",
    fuelType: "hybrid",
    passengers: 7,
    bags: 4,
    transmission: "auto",
  },
  {
    ...
    category: "suv",
    src: carJeepGrandCherokee,
    alt: "Jeep Grand Cherokee - Premium off-road SUV",
    fuelType: "gas",
    passengers: 5,
    bags: 4,
    transmission: "auto",
  },
  // Electric Vehicles - Batch 3
  {
    id: "volkswagen-id4",
    brand: "Volkswagen",
    model: "ID.4",
    category: "electric",
    src: carVolkswagenId4,
    alt: "Volkswagen ID.4 - German electric SUV",
    fuelType: "electric",
    passengers: 5,
    bags: 3,
    transmission: "auto",
  },
  {
    ...
    model: "Ioniq 6",
    category: "electric",
    src: carHyundaiIoniq6,
    alt: "Hyundai Ioniq 6 - Aerodynamic electric sedan",
    fuelType: "electric",
    passengers: 5,
    bags: 2,
    transmission: "auto",
  },
  {
    ...
    category: "electric",
    src: carKiaEv6,
    alt: "Kia EV6 - Korean electric crossover",
    fuelType: "electric",
    passengers: 5,
    bags: 3,
    transmission: "auto",
  },
  {
    ...
    category: "electric",
    src: carFordMachE,
    alt: "Ford Mustang Mach-E - Electric SUV",
    fuelType: "electric",
    passengers: 5,
    bags: 3,
    transmission: "auto",
  },
  {
    ...
    model: "Bolt EV",
    category: "electric",
    src: carChevroletBolt,
    alt: "Chevrolet Bolt EV - Affordable electric hatchback",
    fuelType: "electric",
    passengers: 5,
    bags: 2,
    transmission: "auto",
  },
  {
    ...
    category: "electric",
    src: carBmwIx,
    alt: "BMW iX - German luxury electric SUV",
    fuelType: "electric",
    passengers: 5,
    bags: 3,
    transmission: "auto",
  },
  {
    ...
    category: "electric",
    src: carMercedesEqs,
    alt: "Mercedes EQS - Flagship electric luxury sedan",
    fuelType: "electric",
    passengers: 5,
    bags: 3,
    transmission: "auto",
  },
  {
    ...
    category: "electric",
    src: carAudiEtron,
    alt: "Audi e-tron GT - Electric sports sedan",
    fuelType: "electric",
    passengers: 4,
    bags: 2,
    transmission: "auto",
  },
  {
    ...
    model: "Taycan",
    category: "electric",
    src: carPorscheTaycan,
    alt: "Porsche Taycan - Electric sports car",
    fuelType: "electric",
    passengers: 4,
    bags: 2,
    transmission: "auto",
  },
  {
    ...
    category: "electric",
    src: carNissanAriya,
    alt: "Nissan Ariya - Japanese electric crossover",
    fuelType: "electric",
    passengers: 5,
    bags: 3,
    transmission: "auto",
