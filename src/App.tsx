          ...
          <BrandProvider>
            <TooltipProvider>
              ...
              <BrowserRouter>
                ...
                <Route path="/admin/stores" element={<ProtectedRoute requireAdmin><AdminStoresPage /></ProtectedRoute>} />
                <Route path="/admin/stores/:storeId" element={<ProtectedRoute requireAdmin><AdminStoreEditPage /></ProtectedRoute>} />
