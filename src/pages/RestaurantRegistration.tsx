        ...
        {step === 1 && (
          <div className="grid lg:grid-cols-2 gap-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="space-y-6">
                ...
                {benefits.map((benefit, i) => (
                  <Card key={i} className="border-0 bg-muted/50 hover:bg-muted/70 hover:shadow-sm hover:-translate-y-0.5 transition-all duration-200">
                    <CardContent className="p-4 flex items-start gap-4">
                      <div className="w-10 h-10 rounded-xl bg-eats/10 flex items-center justify-center shrink-0">
              ...
              <div className="p-4 rounded-xl bg-eats/10 border border-eats/20 hover:border-eats/40 hover:shadow-sm transition-all duration-200">
                <p className="text-sm">
