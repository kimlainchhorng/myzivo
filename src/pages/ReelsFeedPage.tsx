    ...
    <>
      ...
      <div className={cn(
        ...
        <PullToRefresh onRefresh={handlePullRefresh} className="min-h-screen bg-background pb-20 lg:pb-0 flex-1 lg:max-w-2xl lg:mx-auto">
          {/* Header */}
          <div data-testid="feed-sticky-header" className="sticky top-0 z-40 bg-background/95 backdrop-blur-xl border-b border-border/30 px-4 py-2.5 flex items-center gap-3 lg:pt-3" style={{ paddingTop: 'var(--zivo-safe-top-sticky)' }}>
