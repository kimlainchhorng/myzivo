    ...
    <div className="min-h-screen bg-background safe-area-top safe-area-bottom">
      ...
      <main className="pt-16 sm:pt-20">
        ...
        <section className="relative py-12 sm:py-20 lg:py-32 overflow-hidden">
          ...
          <div className="absolute top-1/3 right-0 w-[300px] sm:w-[600px] h-[300px] sm:h-[600px] bg-gradient-to-bl from-eats/25 to-orange-500/15 rounded-full blur-3xl" />
          <div className="absolute bottom-0 left-0 w-[250px] sm:w-[500px] h-[250px] sm:h-[500px] bg-gradient-to-tr from-primary/15 to-teal-500/10 rounded-full blur-3xl" />
          
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
              <Badge className="mb-4 sm:mb-6 bg-gradient-to-r from-eats/20 to-orange-500/20 text-eats border-eats/30 px-4 py-2 text-sm font-semibold">
              ...
              <div className="flex flex-wrap gap-3 sm:gap-4 justify-center">
                <Button 
                  size="lg" 
                  className="h-12 sm:h-14 px-6 sm:px-8 text-base sm:text-lg font-bold rounded-2xl bg-gradient-to-r from-eats to-orange-500 text-white shadow-xl shadow-eats/30 hover:opacity-90 gap-2 touch-manipulation active:scale-[0.98]"
                >
                  Schedule Pickup
                  <ChevronRight className="w-5 h-5" />
                </Button>
                <Button variant="outline" size="lg" className="h-12 sm:h-14 px-6 sm:px-8 text-base sm:text-lg font-bold rounded-2xl border-2 gap-2 touch-manipulation active:scale-[0.98]">
                  Get a Quote
                </Button>
              </div>
                ...
                {stats.map((stat, index) => (
                  ...
                  >
                    <div className="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-2 sm:mb-3 rounded-2xl bg-gradient-to-br from-eats/20 to-orange-500/10 flex items-center justify-center">
                      <stat.icon className="w-5 h-5 sm:w-6 sm:h-6 text-eats" />
                    </div>
