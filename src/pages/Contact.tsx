        ...
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="space-y-4 mb-12">
            {contactEmails.map((item) => (
              <Card key={item.email} className="border-border/50 hover:border-primary/20 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
          ...
          {/* Company Info */}
          <Card className="mb-12 border-border/50 bg-muted/30 hover:border-primary/20 hover:shadow-md transition-all duration-200">
            <CardContent className="p-6">
              <div className="flex items-start gap-4">
