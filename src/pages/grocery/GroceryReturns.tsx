/**
 * Grocery Returns & Refund Policy — Instacart-style
 */
import { ArrowLeft, RotateCcw, Camera, Clock, DollarSign, ShieldCheck, PackageX, AlertCircle, CheckCircle } from "lucide-react";
...
const REFUND_TABLE = [
  ...
  { issue: "Item damaged or spoiled", resolution: "Full refund + credit", timeframe: "24 hours" },
...
const STEPS = [
  ...
  { icon: Camera, title: "Provide Evidence", desc: "Upload a photo showing the issue — damaged packaging, wrong item, spoilage, etc." },
  { icon: Clock, title: "Review Period", desc: "Our team reviews your claim within 1–2 business days and may contact you for details." },
      ...
      <div className="sticky top-0 z-30 bg-background/80 backdrop-blur-2xl border-b border-border/20">
        <div className="flex items-center gap-3 px-4 py-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-muted-foreground">ZIVO Grocery Delivery</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-5">
        ...
        <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="p-5 rounded-2xl bg-gradient-to-br from-primary/5 to-primary/[0.02] border border-primary/15 space-y-3">
          ...
          <p className="text-[13px] text-foreground/80 leading-relaxed">
            If you're not satisfied with the quality of your groceries, we'll make it right. Report any issues within 24 hours and we'll refund or replace affected items — no questions asked for your first claim.
          </p>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="p-4 rounded-2xl border border-border/20 bg-card space-y-3">
          ...
          <ul className="text-[12px] text-muted-foreground space-y-1.5 ml-6 list-disc">
            <li>Items correctly delivered as ordered (buyer's remorse)</li>
            <li>Items reported more than 48 hours after delivery</li>
            <li>Delivery and service fees (except for undelivered orders)</li>
            <li>Driver tips</li>
            <li>Gift cards and prepaid cards</li>
            <li>Claims without supporting photo evidence (after first claim)</li>
          </ul>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="p-4 rounded-2xl border border-border/20 bg-card space-y-3">
          ...
          <div className="text-[12px] text-muted-foreground space-y-2 leading-relaxed">
            ...
            <p>• Repeated or excessive claims may require additional review</p>
          </div>
        </motion.div>
