  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4 py-6 sm:py-8 safe-area-top safe-area-bottom relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -left-40 w-[250px] sm:w-[400px] h-[250px] sm:h-[400px] bg-gradient-to-br from-eats/20 to-orange-500/10 rounded-full blur-3xl" />
        <div className="absolute -bottom-40 -right-40 w-[200px] sm:w-[300px] h-[200px] sm:h-[300px] bg-gradient-to-tr from-primary/15 to-teal-500/10 rounded-full blur-3xl" />
      </div>

      <div className="w-full max-w-md relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
        <Card className="border-0 bg-card/95 shadow-2xl backdrop-blur-xl overflow-hidden rounded-3xl">
          <CardHeader className="space-y-1 text-center pb-3 sm:pb-4 pt-6 sm:pt-8">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)}>
              ...
              <CardFooter className="flex flex-col gap-3 sm:gap-4 pt-2 pb-6 sm:pb-8 px-5 sm:px-8">
                <Button 
                  type="submit" 
                  className="w-full h-12 text-base font-bold bg-gradient-to-r from-eats to-orange-500 text-white shadow-lg shadow-eats/30 hover:opacity-90 rounded-xl touch-manipulation active:scale-[0.98]" 
                  disabled={isLoading}
                >
                  {isLoading ? (
