      ...
      <main className="pt-24 pb-20">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <section className="mb-20">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {brandArchitecture.map((service) => (
                <Card key={service.name} className="border-border/50 hover:shadow-lg transition-all">
          ...
          <section className="mb-20">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {brandTone.map((tone) => (
                <div key={tone.label} className="p-6 rounded-2xl bg-muted/30 border border-border/50 text-center">
