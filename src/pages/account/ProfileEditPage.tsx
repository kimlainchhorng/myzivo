...
const SOCIAL_PLATFORMS = [
  ...
  { key: "social_onlyfans" as const, name: "OnlyFans", color: "bg-[#00AFF0]", placeholder: "https://onlyfans.com/username", icon: (
    <svg viewBox="0 0 24 24" className="w-4 h-4 fill-white"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 6.857a5.143 5.143 0 110 10.286 5.143 5.143 0 010-10.286zm0 2.286a2.857 2.857 0 100 5.714 2.857 2.857 0 000-5.714z"/><circle cx="18.5" cy="5.5" r="2.5" fill="white"/></svg>
  )},
];
