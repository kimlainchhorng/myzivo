...
const legalItems = [
  ...
  { icon: Globe, label: "GDPR Compliance", description: "EU data protection rights", href: "/legal/gdpr", color: "bg-blue-500/15", iconColor: "text-blue-500" },
  ...
  { icon: Car, label: "Car Rental Disclaimer", description: "Vehicle marketplace rules", href: "/legal/car-rental-disclaimer", color: "bg-violet-500/15", iconColor: "text-violet-500" },
  { icon: Car, label: "Transportation Disclaimer", description: "Ride-hailing & delivery disclaimer", href: "/legal/transportation-disclaimer", color: "bg-blue-500/15", iconColor: "text-blue-500" },
  { icon: Umbrella, label: "Insurance Disclaimer", description: "Insurance information notice", href: "/legal/insurance-disclaimer", color: "bg-amber-500/15", iconColor: "text-amber-500" },
  { icon: AlertTriangle, label: "Damage Policy", description: "Vehicle damage & incident claims", href: "/legal/damage-policy", color: "bg-red-500/15", iconColor: "text-red-500" },
  ...
  { icon: Ban, label: "No Guarantee Disclaimer", description: "Price & outcome disclaimers", href: "/legal/no-guarantee", color: "bg-amber-500/15", iconColor: "text-amber-500" },
  { icon: ShieldCheck, label: "Warranty Disclaimer", description: "'As is' service disclaimer", href: "/legal/warranty-disclaimer", color: "bg-amber-500/15", iconColor: "text-amber-500" },
  ...
  { icon: Heart, label: "Non-Discrimination", description: "Equal access & ADA compliance", href: "/legal/non-discrimination", color: "bg-emerald-500/15", iconColor: "text-emerald-500" },

  // Security & Fraud
  { icon: ShieldAlert, label: "Fraud Prevention", description: "Zero-tolerance fraud enforcement", href: "/legal/fraud-prevention", color: "bg-red-500/15", iconColor: "text-red-500" },
  ...
  { icon: Fingerprint, label: "Partner Agreement", description: "Service provider terms", href: "/partner-agreement", color: "bg-slate-500/15", iconColor: "text-slate-500" },
];
