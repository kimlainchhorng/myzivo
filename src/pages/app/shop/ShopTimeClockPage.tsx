    ...
    <AppLayout title="Time Clock" hideHeader>
      <div className="flex flex-col px-4 pt-3 pb-24">
        ...
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <h2 className="font-semibold text-[15px] mb-1">Clock In & Out</h2>
          <p className="text-[13px] text-muted-foreground max-w-[260px]">Track employee clock-in/out times, attendance, and work hours.</p>
        </div>
      </div>
    </AppLayout>
  );
