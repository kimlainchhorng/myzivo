...
const quickActions = [
  ...
  { label: "Delivery", icon: Package, href: "/extras", gradient: "from-violet-500 to-purple-600", bg: "bg-violet-500/8", iconBg: "bg-gradient-to-br from-violet-400/25 to-violet-600/15", color: "text-violet-600 dark:text-violet-400", accent: "bg-violet-500", tagline: "Send packages" },
