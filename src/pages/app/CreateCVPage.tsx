      ...
      <div className="flex flex-col px-3.5 pt-2.5 pb-24">
        ...
        <Section icon={Briefcase} title="Work Experience" index={1}>
          <div className="space-y-3">
            {experiences.map((exp, i) => (
              <div key={exp.id} className="relative rounded-lg border border-border/30 bg-muted/20 p-2.5 space-y-2">
        ...
        <Section icon={GraduationCap} title="Education" index={2}>
          <div className="space-y-3">
            ...
            <button onClick={addEducation} className="w-full py-1.5 rounded-lg border border-dashed border-primary/30 text-primary text-[12px] font-semibold flex items-center justify-center gap-1 touch-manipulation active:scale-[0.98]">
