    ...
    <AppLayout title="Schedule" hideHeader>
      <div className="flex flex-col px-4 pt-3 pb-24">
        <div className="flex items-center gap-2.5 mb-6">
          ...
          <h1 className="font-bold text-[17px]">Schedule</h1>
        </div>
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <h2 className="font-semibold text-[15px] mb-1">Work Schedule</h2>
          <p className="text-[13px] text-muted-foreground max-w-[260px]">View your upcoming shifts and work schedule here.</p>
        </div>
      </div>
    </AppLayout>
  );
