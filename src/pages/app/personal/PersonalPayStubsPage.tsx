    ...
    <AppLayout title="Pay Stubs" hideHeader>
      <div className="flex flex-col px-4 pt-3 pb-24">
        <div className="flex items-center gap-2.5 mb-6">
          ...
          <h1 className="font-bold text-[17px]">Pay Stubs</h1>
        </div>
        <div className="flex flex-col items-center justify-center py-16 text-center">
          <div className="w-14 h-14 rounded-full bg-emerald-500/10 flex items-center justify-center mb-4">
            <FileText className="w-7 h-7 text-emerald-500" />
          </div>
          <h2 className="font-semibold text-[15px] mb-1">Earnings & Deductions</h2>
          <p className="text-[13px] text-muted-foreground max-w-[260px]">View your pay stubs, earnings breakdown, and deductions.</p>
        </div>
      </div>
    </AppLayout>
  );
