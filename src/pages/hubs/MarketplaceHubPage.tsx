    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-24 pb-24 container mx-auto px-4">
        <div className="flex items-center justify-between mb-6">
          ...
          <button type="button" onClick={() => navigate("/marketplace-hub/create")} className="inline-flex items-center gap-1 px-3 py-2 rounded-xl bg-primary text-primary-foreground text-sm font-bold">
