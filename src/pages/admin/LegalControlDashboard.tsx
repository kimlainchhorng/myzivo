      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <Tabs defaultValue="protections" className="space-y-6">
          ...
          <TabsContent value="protections" className="space-y-6">
            ...
            {/* Legal Evidence Policies (180-187) */}
            <Card className="mt-6">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <Shield className="h-5 w-5 text-rose-500" />
                  Legal Documentation & Evidence (180-187)
                </CardTitle>
                <CardDescription>
                  Evidence systems, case files, and response protocols
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
                  {LEGAL_EVIDENCE_POLICIES_LIST.map((policy) => (
                    <div
                      key={policy.id}
