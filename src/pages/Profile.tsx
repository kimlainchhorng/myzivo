                    ...
                    <div className="px-6 pb-1.5 pt-2 text-left">
                      ...
                      <div className="lg:hidden mt-3 grid grid-cols-4 gap-2">
                        {[
                          ...
                          { label: "Employees", icon: Users, onClick: () => { selectionChanged(); if (!user) { toast.info("Sign in to open Personal Account"); navigate("/login?redirect=/n-dashboard"); return; } navigate("/n-dashboard"); } },
