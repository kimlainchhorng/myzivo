...
import { ArrowLeft, Shield, UserCheck, AlertTriangle, Ban } from "lucide-react";
...
export default function VerificationPolicy() {
  const policy = EXTREME_LEGAL_POLICIES.userVerification;
          ...
          <CardContent>
            <div className="flex items-start gap-3">
              ...
              <p className="text-destructive font-medium">
                Providing false identity information constitutes fraud and will result in 
                immediate permanent ban from the platform and potential referral to law enforcement.
              </p>
            </div>
          </CardContent>
        </Card>
