 ...
 * Full booking management for P2P renters
 */
...
import {
  ...
  ChevronRight, Search, ArrowLeft, Star
} from "lucide-react";
...
const statusBadges = {
  ...
  active: { variant: "default" as const, label: "In Progress" },
      ...
      <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-xl border-b border-border/50">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <Button onClick={() => navigate("/cars")} size="sm" className="gap-2">
