...
const ZivoMobileNav = () => {
  ...
  const tabs: NavTab[] = [
    ...
    { id: "feed", labelKey: "nav.reel", icon: Newspaper, path: "/feed", bg: navSearchBg, cssVar: "var(--flights)" },
    { id: "reel", labelKey: "nav.feed", icon: Film, path: "/reels", bg: navSearchBg, cssVar: "var(--flights)" },
