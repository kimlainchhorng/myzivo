...
const ZivoMobileNav = () => {
  ...
  const tabs: NavTab[] = [
    ...
    { id: "feed", labelKey: "nav.reel", icon: Newspaper, path: "/reels", bg: navSearchBg, cssVar: "var(--flights)" },
    { id: "reel", labelKey: "nav.feed", icon: Film, path: "/feed", bg: navSearchBg, cssVar: "var(--flights)" },
  ...
  const getActiveTab = () => {
    ...
    if (path.startsWith("/account") || path.startsWith("/profile") || path.startsWith("/more") || path.startsWith("/personal-dashboard") || path.startsWith("/personal/") || path.startsWith("/shop-dashboard")) return "account";
    return "home";
  };
