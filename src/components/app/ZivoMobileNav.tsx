...
const ZivoMobileNav = () => {
  ...
  const tabs: NavTab[] = [
    ...
    { id: "reel", labelKey: "nav.feed", icon: Newspaper, path: "/reels", bg: navSearchBg, cssVar: "var(--flights)" },
    { id: "feed", labelKey: "nav.reel", icon: Film, path: "/feed", bg: navSearchBg, cssVar: "var(--flights)" },
