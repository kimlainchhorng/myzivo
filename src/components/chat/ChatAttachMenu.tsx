...
<<<<<<< HEAD
      case "scan":
        if (onScanDocument) {
          ...
          // Fall back to image picker which works as a document scanner on mobile
          onImageSelect();
        }
        break;
=======
      ...
      {open && pos && (
        <>
          ...
          <motion.div
            ...
            className="fixed z-[1401] bg-background/95 backdrop-blur-xl border border-border/20 rounded-2xl shadow-2xl p-4 max-w-[320px]"
