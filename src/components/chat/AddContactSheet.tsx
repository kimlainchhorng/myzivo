      ...
      <SheetContent side="bottom" className="rounded-t-3xl max-h-[85vh]">
        <SheetHeader className="text-left">
          <SheetTitle className="flex items-center gap-2">
            {zivoOFMode ? (
              <>
                <LinkIcon className="w-5 h-5 text-[#00AEEF]" /> Share my page
              </>
            ) : (
              <>
        ...
        <div className="mt-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3 pt-2">
            ...
            >
              <QrCode className={`w-6 h-6 ${zivoOFMode ? "text-[#00AEEF]" : "text-emerald-500"}`} />
            ...
            <button type="button"
              ...
              className="flex flex-col items-center gap-2 p-4 rounded-2xl border bg-card hover:bg-muted active:scale-95 transition"
            >
              <LinkIcon className={`w-6 h-6 ${zivoOFMode ? "text-[#00AEEF]" : "text-emerald-500"}`} />
