        ...
        <div className="relative overflow-hidden py-3 sm:py-4">
          <div className="flex items-center justify-center gap-2 sm:gap-4 md:gap-6 flex-wrap">
            {trustBadges.map((badge, index) => (
              <div
                key={badge.label}
                className="flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-4 py-1.5 sm:py-2 rounded-full bg-card/50 backdrop-blur-xl border border-border/50 hover:border-amber-500/30 transition-all duration-200 animate-in fade-in"
