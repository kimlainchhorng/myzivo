...
const sizeClasses = {
  sm: { container: "h-7 sm:h-8", icon: "w-6 h-6 sm:w-7 sm:h-7", text: "text-lg sm:text-xl" },
  md: { container: "h-8 sm:h-10", icon: "w-7 h-7 sm:w-9 sm:h-9", text: "text-xl sm:text-2xl" },
  lg: { container: "h-12 sm:h-14", icon: "w-10 h-10 sm:w-12 sm:h-12", text: "text-2xl sm:text-3xl" },
  xl: { container: "h-16 sm:h-20", icon: "w-14 h-14 sm:w-18 sm:h-18", text: "text-3xl sm:text-4xl" },
};
  ...
  return (
    <div className={cn("flex items-center gap-2", sizes.container, className)}>
      ...
      <div className={cn(
        ...
        <span className="font-display font-bold text-white" style={{ fontSize: 'inherit' }}>
