  ...
  return (
    <div className={cn("space-y-6", className)}>
      <div className="text-center">
        <h3 className="font-display text-xl font-bold mb-2">Complete Your Trip</h3>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-2 mb-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Find places to stay</p>
              </div>
            </div>
            ...
            <div className="space-y-2 mb-3">
              {hotelPartners.slice(0, 2).map((partner) => (
                <button
                  ...
                  className="w-full flex items-center justify-between p-2 rounded-lg bg-background/50 hover:bg-background transition-colors text-left"
                >
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-2 mb-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Drive at your destination</p>
              </div>
            </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-2 mb-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Protect your trip</p>
              </div>
            </div>
