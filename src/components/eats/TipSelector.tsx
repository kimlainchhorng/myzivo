        ...
        {TIP_PERCENTAGES.map((pct) => {
          ...
          return (
            <button
              ...
              className={cn(
                "flex-1 py-3 rounded-xl border text-center transition-all duration-200 active:scale-[0.97] touch-manipulation",
                isActive
        ...
        <DialogContent className="bg-zinc-900 border-white/10 max-w-xs">
          ...
          <div className="space-y-4">
            ...
            <Button
              ...
              className="w-full bg-orange-500 hover:bg-orange-600 text-white font-bold h-11 rounded-xl active:scale-[0.97] transition-all duration-200 touch-manipulation shadow-md"
            >
              Add Tip
            </Button>
          </div>
