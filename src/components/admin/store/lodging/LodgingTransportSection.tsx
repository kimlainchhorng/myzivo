  ...
  return (
    <SectionShell title="Transport & Transfers" subtitle="Airport, ferry, boat, scooter, car rental, parking, and arrival logistics." icon={Car}>
      {isLoading ? <LoadingPanel /> : <>
        ...
        <AddonList addons={transport} emptyTitle="No transport add-ons yet" emptyBody="Add airport pickup, airport drop-off, ferry transfer, private boat transfer, scooter rental, and car rental." />
