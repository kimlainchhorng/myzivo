  ...
  return (
    ...
    >
      <motion.button
        ...
        disabled={isDisabled}
        className={cn(
          "w-full py-4 rounded-2xl font-semibold text-sm flex items-center justify-center gap-2 transition-all duration-200 touch-manipulation shadow-lg shadow-primary/20",
