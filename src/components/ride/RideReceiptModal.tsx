        ...
        >
          ...
          <div className="flex justify-center gap-2">
            {[1, 2, 3, 4, 5].map((star) => (
              <motion.button
                ...
                className="p-1 transition-all duration-200 disabled:opacity-50 active:scale-90 touch-manipulation"
              >
                <Star
                  className={cn(
              ...
              <div className="flex flex-wrap gap-1.5">
                {RIDE_FEEDBACK_TAGS.map((tag) => (
                  <button
                    ...
                    className={cn(
                      "px-2.5 py-1 rounded-full text-xs font-medium transition-all duration-200 border touch-manipulation active:scale-90",
          ...
          {!hasRated && (
            <Button
              ...
              className="w-full mt-3 h-11 bg-primary hover:bg-primary/90 rounded-xl font-bold shadow-md active:scale-[0.97] transition-all duration-200 touch-manipulation"
            >
              {isSaving ? (
                <>
            ...
            <>
              <div className="flex justify-center gap-2">
                {[1, 3, 5].map((amount) => (
                  <motion.button
                    ...
                    className={cn(
                      "px-5 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 border touch-manipulation active:scale-[0.95]",
                      selectedTip === amount
                ...
                <motion.button
                  ...
                  className={cn(
                    "px-4 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 border touch-manipulation active:scale-[0.95]",
              ...
              {selectedTip && (
                <motion.button
                  ...
                  className="block mx-auto mt-2 text-xs text-white/40 hover:text-white/60 transition-all duration-200 touch-manipulation active:scale-95"
                >
                  No tip
                </motion.button>
              )}
              ...
              <Button
                onClick={() => {
                  ...
                  if (!isNaN(value) && value >= 0) {
                    setSelectedTip(Math.round(value * 100) / 100);
                    setShowCustomTip(false);
                    setCustomTipValue("");
                  }
                }}
