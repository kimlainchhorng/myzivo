  ...
  return (
    ...
    >
      ...
      <div 
        ...
        style={{ zIndex: 100 }}
      >
        {/* Outer ping ring - high contrast on dark map */}
        <div className="absolute w-16 h-16 rounded-full bg-blue-400/40 animate-ping" />
        
        {/* Inner pulse ring */}
        <div className="absolute w-10 h-10 rounded-full bg-blue-400/30 animate-pulse" />
        
        {/* Center pin - high contrast blue with white border */}
