 ...
 * Ready-to-use content for social, email, and marketing
 */
...
export const { short: shortAnnouncement, full: fullAnnouncement, banner: bannerContent, trustPoints, footerNote, social: socialPosts } = launchContent;
