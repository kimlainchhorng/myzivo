...
const extras = [
  {
    ...
    description: "Book reliable airport pickups and drop-offs",
    icon: Bus,
  ...
  },
  {
    id: "esim",
    title: "Travel eSIM",
    description: "Stay connected abroad with instant data",
    icon: Wifi,
    href: "/esim",
  },
  {
  ...
  },
  {
    ...
    description: "Claim money for delayed or cancelled flights",
    icon: Shield,
    href: "/flight-compensation",
  },
  {
    id: "activities",
    title: "Activities & Tours",
    description: "Book experiences at your destination",
    icon: Ticket,
    href: "/things-to-do",
  },
];
