/**
 * FeaturedHotelsSection - Hotel room cards with price overlays
 */
...
const hotels = [
  { name: "The Grand Plaza", location: "New York, USA", price: 189, rating: 4.8, image: "https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&q=80&w=500" },
  { name: "Ocean Breeze Resort", location: "Cancún, Mexico", price: 145, rating: 4.7, image: "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?auto=format&fit=crop&q=80&w=500" },
  { name: "Sakura Garden Hotel", location: "Tokyo, Japan", price: 210, rating: 4.9, image: "https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?auto=format&fit=crop&q=80&w=500" },
  { name: "Le Château Royal", location: "Paris, France", price: 275, rating: 4.8, image: "https://images.unsplash.com/photo-1582719508461-905c673771fd?auto=format&fit=crop&q=80&w=500" },
];
