          ...
          >
            ...
            <div className="flex flex-wrap gap-3">
              <button
                ...
                className="inline-flex items-center gap-3 px-6 py-3.5 rounded-xl bg-foreground text-background font-semibold text-sm hover:opacity-90 active:scale-[0.97] transition-all"
              >
