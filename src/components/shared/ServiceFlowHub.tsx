...
const allServices: ServiceStep[] = [
  ...
  { id: "events", label: "Events", icon: Ticket, href: "/events", color: "text-pink-500", bgColor: "bg-pink-500/10" },
  { id: "transport", label: "Transport", icon: Train, href: "/ground-transport", color: "text-indigo-500", bgColor: "bg-indigo-500/10" },
