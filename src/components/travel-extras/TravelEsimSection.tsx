      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-5xl mx-auto">
          {esimCards.map((provider, index) => (
            <Card 
              key={provider.id}
              className="group cursor-pointer border-border/50 hover:border-cyan-500/50 hover:shadow-lg hover:shadow-cyan-500/10 transition-all duration-300 overflow-hidden animate-in fade-in slide-in-from-bottom-4"
            ...
            >
              ...
              <CardContent className="p-5">
                ...
                <Button 
                  size="sm"
                  className="w-full gap-2 bg-gradient-to-r from-cyan-500 to-teal-500 text-white hover:opacity-90 touch-manipulation"
                >
