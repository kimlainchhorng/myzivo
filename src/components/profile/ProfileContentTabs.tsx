              ...
              >
                ...
                <div className="flex gap-4 overflow-x-auto pb-2" style={{ scrollbarWidth: "none" }}>
                  {(() => {
                    ...
                    const opts = [
                      { label: "WhatsApp", color: "bg-[#25D366]/10", icon: <svg viewBox="0 0 24 24" className="w-7 h-7" fill="#25D366"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>, action: () => window.open(`https://wa.me/?text=${encodeURIComponent(shareCaption + "\n" + shareUrl)}`, "_blank") },
                      { label: "Telegram", color: "bg-[#0088cc]/10", icon: <svg viewBox="0 0 24 24" className="w-7 h-7" fill="#0088cc"><path d="M11.944 0A12 12 0 000 12a12 12 0 0012 12 12 12 0 0012-12A12 12 0 0012 0h-.056zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 01.171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.479.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z"/></svg>, action: () => window.open(`https://t.me/share/url?url=${encodeURIComponent(shareUrl)}&text=${encodeURIComponent(shareCaption)}`, "_blank") },
                      { label: "Facebook", color: "bg-[#1877F2]/10", icon: <svg viewBox="0 0 24 24" className="w-7 h-7" fill="#1877F2"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>, action: () => window.open(`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(shareUrl)}`, "_blank") },
                      { label: "X", color: "bg-foreground/5", icon: <svg viewBox="0 0 24 24" className="w-6 h-6" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>, action: () => window.open(`https://twitter.com/intent/tweet?url=${encodeURIComponent(shareUrl)}&text=${encodeURIComponent(shareCaption)}`, "_blank") },
                      { label: "Instagram", color: "bg-[#E4405F]/10", icon: <svg viewBox="0 0 24 24" className="w-7 h-7" fill="#E4405F"><path d="M12 0C8.74 0 8.333.015 7.053.072 5.775.132 4.905.333 4.14.63c-.789.306-1.459.717-2.126 1.384S.935 3.35.63 4.14C.333 4.905.131 5.775.072 7.053.012 8.333 0 8.74 0 12s.015 3.667.072 4.947c.06 1.277.261 2.148.558 2.913.306.788.717 1.459 1.384 2.126.667.666 1.336 1.079 2.126 1.384.766.296 1.636.499 2.913.558C8.333 23.988 8.74 24 12 24s3.667-.015 4.947-.072c1.277-.06 2.148-.262 2.913-.558.788-.306 1.459-.718 2.126-1.384.666-.667 1.079-1.335 1.384-2.126.296-.765.499-1.636.558-2.913.06-1.28.072-1.687.072-4.947s-.015-3.667-.072-4.947c-.06-1.277-.262-2.149-.558-2.913-.306-.789-.718-1.459-1.384-2.126C21.319 1.347 20.651.935 19.86.63c-.765-.297-1.636-.499-2.913-.558C15.667.012 15.26 0 12 0zm0 2.16c3.203 0 3.585.016 4.85.071 1.17.055 1.805.249 2.227.415.562.217.96.477 1.382.896.419.42.679.819.896 1.381.164.422.36 1.057.413 2.227.057 1.266.07 1.646.07 4.85s-.015 3.585-.074 4.85c-.061 1.17-.256 1.805-.421 2.227-.224.562-.479.96-.899 1.382-.419.419-.824.679-1.38.896-.42.164-1.065.36-2.235.413-1.274.057-1.649.07-4.859.07-3.211 0-3.586-.015-4.859-.074-1.171-.061-1.816-.256-2.236-.421-.569-.224-.96-.479-1.379-.899-.421-.419-.69-.824-.9-1.38-.165-.42-.359-1.065-.42-2.235-.045-1.26-.061-1.649-.061-4.844 0-3.196.016-3.586.061-4.861.061-1.17.255-1.814.42-2.234.21-.57.479-.96.9-1.381.419-.419.81-.689 1.379-.898.42-.166 1.051-.361 2.221-.421 1.275-.045 1.65-.06 4.859-.06l.045.03zm0 3.678a6.162 6.162 0 100 12.324 6.162 6.162 0 100-12.324zM12 16c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4zm7.846-10.405a1.441 1.441 0 11-2.882 0 1.441 1.441 0 012.882 0z"/></svg>, action: () => { try { navigator.clipboard.writeText(shareCaption + "\n" + shareUrl); } catch {} window.open("https://www.instagram.com/", "_blank"); toast.success("Link copied! Paste it on Instagram"); } },
                      { label: "Snapchat", color: "bg-[#FFFC00]/10", icon: <svg viewBox="0 0 24 24" className="w-7 h-7" fill="#FFFC00"><path d="M12.206.793c.99 0 4.347.276 5.93 3.821.529 1.193.403 3.219.299 4.847l-.003.06c-.012.18-.022.345-.03.51.075.045.203.09.401.09.3-.016.659-.12.983-.278.096-.05.19-.078.3-.078a.47.47 0 01.331.135c.145.135.2.315.185.5-.025.302-.22.534-.54.672-.168.073-.356.12-.553.155-.192.034-.399.06-.617.082a.738.738 0 00-.639.51c-.065.177-.098.36-.116.547a8.4 8.4 0 01-.202.855c-.555 1.68-1.8 2.94-3.59 3.638a7.04 7.04 0 01-.655.226c-.296.087-.474.14-.566.247-.1.115-.12.297-.063.553.078.345-.064.502-.18.586-.244.176-.636.26-1.128.26a3.72 3.72 0 01-.592-.049 5.28 5.28 0 00-.782-.074c-.278 0-.553.03-.834.09-.287.06-.596.18-.926.36-.544.296-1.07.45-1.564.45-.02 0-.044 0-.064-.003a3.04 3.04 0 01-1.508-.448 4.41 4.41 0 00-.928-.362 5.63 5.63 0 00-.833-.09 5.18 5.18 0 00-.782.074c-.174.028-.387.049-.592.049-.492 0-.884-.084-1.128-.26-.116-.084-.258-.241-.18-.586.057-.256.037-.438-.063-.553-.092-.107-.27-.16-.566-.247a7.04 7.04 0 01-.655-.226c-1.79-.698-3.035-1.958-3.59-3.638a8.4 8.4 0 01-.202-.855 2.5 2.5 0 00-.116-.547.738.738 0 00-.639-.51 7.7 7.7 0 01-.617-.082 3.1 3.1 0 01-.553-.155c-.32-.138-.515-.37-.54-.672a.47.47 0 01.186-.5.47.47 0 01.33-.135c.11 0 .204.028.3.078.324.158.683.262.983.278.198 0 .326-.045.401-.09a9.1 9.1 0 01-.03-.51l-.003-.06c-.104-1.628-.23-3.654.3-4.847C5.66 1.069 9.015.793 10.006.793h.1z"/></svg>, action: () => window.open(`https://www.snapchat.com/scan?attachmentUrl=${encodeURIComponent(shareUrl)}`, "_blank") },
                      { label: "Email", color: "bg-muted", icon: <svg viewBox="0 0 24 24" className="w-7 h-7 text-muted-foreground" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>, action: () => window.open(`mailto:?subject=${encodeURIComponent(shareCaption)}&body=${encodeURIComponent(shareUrl)}`, "_self") },
                      { label: "SMS", color: "bg-emerald-500/10", icon: <svg viewBox="0 0 24 24" className="w-7 h-7 text-emerald-500" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z"/></svg>, action: () => window.open(`sms:?body=${encodeURIComponent(shareCaption + "\n" + shareUrl)}`, "_self") },
                      { label: "Copy Link", color: "bg-primary/10", icon: <Link2 className="w-7 h-7 text-primary" />, action: async () => { try { await navigator.clipboard.writeText(shareUrl); } catch { const ta = document.createElement("textarea"); ta.value = shareUrl; ta.style.position = "fixed"; ta.style.opacity = "0"; document.body.appendChild(ta); ta.select(); document.execCommand("copy"); document.body.removeChild(ta); } toast.success("Link copied!"); } },
                    ];
                    return opts.map((opt) => (
                      <button
                        key={opt.label}
                        onClick={() => { opt.action(); if (opt.label !== "Copy Link") setSharePostId(null); }}
