...
export const AUTO_REPAIR_TAB_IDS = ["ar-invoices", "ar-autocheck", "ar-parts", "ar-inspections", "ar-vehicles", "ar-estimates", "ar-workorders", "ar-techs", "ar-reminders", "ar-tires", "ar-warranty", "ar-fleet", "ar-reports"] as const;
