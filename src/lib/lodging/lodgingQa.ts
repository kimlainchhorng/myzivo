...
export function runLodgingQa(input: LodgingQaInput) {
  ...
  const checks: LodgingQaCheck[] = [
    ...
    { id: "sidebar-tabs", name: "All lodging sidebar tabs registered", status: LODGING_TAB_IDS.length === 28 ? "pass" : "fail", detail: `${LODGING_TAB_IDS.length}/28 lodging tabs are registered.`, category: "system" },
