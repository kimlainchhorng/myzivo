  ...
  public: {
    Tables: {
      ...
      flight_admin_alerts: {
        ...
        Relationships: [
          {
            foreignKeyName: "flight_admin_alerts_booking_id_fkey"
            columns: ["booking_id"]
            isOneToOne: false
      ...
      flight_email_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "flight_email_logs_booking_id_fkey"
            columns: ["booking_id"]
            isOneToOne: false
            referencedRelation: "flight_bookings"
            referencedColumns: ["id"]
      ...
      item_option_groups: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "item_option_groups_option_group_id_fkey"
